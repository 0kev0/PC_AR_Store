...
public class AR_test extends AppCompatActivity implements SampleRender.Renderer {
        ...
        settingsButton.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        PopupMenu popup = new PopupMenu(AR_test.this, v);
                        popup.setOnMenuItemClickListener(AR_test.this::settingsMenuClick);
